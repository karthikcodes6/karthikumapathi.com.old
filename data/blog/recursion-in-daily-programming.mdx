...
draft: false
summary: Learn how to use recurssion in your daily programming!
---
...
findCorrectObject(
  [
    { id: '3434343', title: 'title 1' },
    { id: '45454565', title: 'title 2' },
  ],
  '3434343'
)
```
